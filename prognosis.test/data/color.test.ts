...
test("Color.hsl", () => {
	expect(
		Color.hsl(4.4238753693407284, 0.4851485148514851, 0.8019607843137255).hex
	).toBe("#bfb4e5ff");
	expect(
		Color.hsl(4.410312763693364, 0.8965517241379314, 0.8862745098039215).hex
	).toBe("#d3c8fcff");
	expect(
		Color.hsl(4.1887902047863905, 0.5853658536585368, 0.6784313725490196).hex
	).toBe("#7d7dddff");
});
